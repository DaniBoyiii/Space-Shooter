...
void init()
{
    ...
    gluOrtho2D(-1200,1200,-700,650);                   //<-----CHANGE THIS TO GET EXTRA SPACE
...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-685, 490, 0.0,"JAYPEE INSTITUTE OF  INFORMATION TECHNOLOGY");
	...
	//  	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," YASHWARDHAN DANI 211207");
	displayRasterText(-800, -285, 0.0, " TANISHA 211204");
	displayRasterText(-800, -370, 0.0," MEGHNA THAKUR 211234");
	glColor3f(1.0, 0.0, 0.0);

	displayRasterText(-250, -450, 0.0,"Academic Year 2023-2024");
        glColor3f(1.0, 1.0, 1.0);
